...
class RemoteDeploymentTests(unittest.TestCase):
    ...
    def test_dashboard_binds_only_to_tailscale_and_snapshot_has_no_network(self):
        dashboard_block = self.compose.split("  dashboard:", 1)[1].split(
            "\nnetworks:", 1
        )[0]
        self.assertIn('"100.110.79.52:5000:8080"', dashboard_block)
        self.assertNotIn('"0.0.0.0:', dashboard_block)
